...
<html lang="en">
  ...
  <body>
    ...
    <nav class="w-full py-4 md:py-0 md:h-16 px-4 bg-deep-blue text-white">
      <div
        class="container h-full mx-auto flex flex-col gap-2 md:gap-0 md:flex-row justify-between items-center"
      >
    ...
    >
      ...
      >
        <button
          ...
          class="absolute top-4 right-4 text-3xl text-deep-blue"
        >
          &times;
        </button>
        ...
        <div>
          ...
          >
            <a href="#" class="block py-1 text-base hover:text-slate-500"
              >Research</a
            >
            <a href="#" class="block py-1 text-base hover:text-slate-500"
              >Academic Papers</a
            ...
            >
            <a href="#" class="block py-1 text-base hover:text-slate-500"
              >Center for Holistic International Human Rights Law Praxis</a
            >
            <a href="#" class="block py-1 text-base"
              >Center for Land and Natural Resources Policy</a
            >
            <a href="#" class="block py-1 text-base"
              >Center for Constitution & Democratic Governance</a
