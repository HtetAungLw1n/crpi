...
<section class="w-full relative">
    ...
    <div class="bg-deep-blue font-playfair py-16 text-white text-center">
        <div class="text-4xl font-bold mb-4">Public Policy, Law and Diplomacy,</div>
        <div class="text-xl font-notoserif">Home > Publication > Public Policy, Law and Diplomacy,</div>
    </div>
</section>
<!-- hero section  -->
...
<section class="container mx-auto px-4 md:px-0 py-20">
    <div class="flex gap-10 justify-center items-start px-20 h-[40vh]">
        <div class="font-notoserif ">
            <div class="font-playfair text-4xl font-bold text-deep-blue">Public Policy, Law and Diplomacy,</div>
