...
<section class="container mx-auto px-4 py-20">
    ...
    <!-- first text-area  -->
    <div>
        <div class="text-4xl font-bold font-playfair my-8">Research Fellow - Center for Research, Policy and Innovation
            (CRPI)</div>

        <!-- date and time -->
        <div class="flex items-center justify-start text-deep-blue gap-4">
            <div class="flex items-start lg:items-center gap-2"><img src="./icons/calendar-deep-blue-2.svg"
                    alt="calendar">January 20,
                2024
            </div>
            <div class="flex items-start lg:items-center gap-2"><img src="./icons/clock-deep-blue.svg" alt="clock">11:30
                pm</div>
            <div class="flex items-start lg:items-center gap-2"><img src="./icons/category-name.svg"
                    alt="category">Category Name</div>
        </div>
